...
1.  First terminal:
        ...
        docker run -it --rm --name=inotify --volume $(pwd)/imasdb:/home/imas/public/imasdb --mount 'type=tmpfs,destination=/home/imas/public/imasdb/test' imas/testing
...
2.  Second terminal:
        ...
        docker run -it --rm --name=imas --volume $(pwd)/imasdb:/home/imas/public/imasdb --mount 'type=tmpfs,destination=/home/imas/public/imasdb/test' imas/testing
